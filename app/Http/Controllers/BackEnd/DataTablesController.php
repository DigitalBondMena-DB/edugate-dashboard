...
class DataTablesController extends Controller
{
    public function adsListView() {
        return view('backend.datatables.list.list_ads_datatables');
    }
    ...
    public function socialMediaListView() {
        return view('backend.datatables.list.list_social_media_datatables');
    }
    ...
    public function listView() {
        return view('backend.datatables.list.list_datatables');
    }
    ...
    public function registerView() {
        return view('backend.datatables.register.register_datatables');
    }
    ...
    public function listBachelorView() {
        return view('backend.datatables.list.list_bachelor_datatables');
    }
    ...
    public function getListBachelorDataUserCreate() {
        $academicGuides = User::where('role', 'academic-guide')->get();

        return response()->json([
            'academicGuides' => $academicGuides
        ], 200);
    }
    ...
    public function getListBachelorDataUserStore(Request $request) {
        ...
        $user->user_admission_forms()->create([
            ...
            'degree_needed' => $request->degree_needed,
            'academic_guide' => $request->academic_guide_list_bachelor,
            'en_academic_guide' => User::where('role', 'academic-guide')->where('name', $request->academic_guide_list_bachelor)->first()->en_name,
    ...
    public function listMasterView() {
        return view('backend.datatables.list.list_master_datatables');
    }
    ...
    public function getListMasterDataUserCreate() {
        $academicGuides = User::where('role', 'academic-guide')->get();
    ...
    public function getListMasterDataUserStore(Request $request) {
        ...
        $user->user_admission_forms()->create([
            ...
            'department' => $request->department,
            'degree_needed' => $request->degree_needed,
            'academic_guide' => $request->academic_guide_list_master,
            'en_academic_guide' => User::where('role', 'academic-guide')->where('name', $request->academic_guide_list_master)->first()->en_name,
            'registered' => $request->registered,
            'day' => Carbon::now()->format('d'),
            'month' => Carbon::now()->format('F'),
            'year' => Carbon::now()->format('Y'),
    ...
    public function listPhdView() {
        return view('backend.datatables.list.list_phd_datatables');
    }
    ...
    public function getListPhdDataUserCreate() {
        $academicGuides = User::where('role', 'academic-guide')->get();
    ...
    public function getListPhdDataUserStore(Request $request) {
        ...
        $user->user_admission_forms()->create([
            ...
            'department' => $request->department,
            'degree_needed' => $request->degree_needed,
            'academic_guide' => $request->academic_guide_list_phd,
            'en_academic_guide' => User::where('role', 'academic-guide')->where('name', $request->academic_guide_list_phd)->first()->en_name,
            'registered' => $request->registered,
            'day' => Carbon::now()->format('d'),
            'month' => Carbon::now()->format('F'),
            'year' => Carbon::now()->format('Y'),
    ...
    public function registerBachelorView() {
        return view('backend.datatables.register.register_bachelor_datatables');
    }
    ...
    public function registerBachelorDataUserIdUpdate(Request $request) {
        ...
        $userAdmissionInfo->update([
            ...
            'academic_guide' => $request->academic_guide_register_bachelor,
            'en_academic_guide' => User::where('role', 'academic-guide')->where('name', $request->academic_guide_register_bachelor)->first()->en_name,
    ...
    public function registerMasterView() {
        return view('backend.datatables.register.register_master_datatables');
    }
    ...
    public function registerMasterDataUserIdUpdate(Request $request) {
        ...
        $userAdmissionInfo->update([
            ...
            'accounts_status' => $request->accounts_status,
            'correspondence' => $request->correspondence,
            'academic_guide' => $request->academic_guide_register_master,
            'en_academic_guide' => User::where('role', 'academic-guide')->where('name', $request->academic_guide_register_master)->first()->en_name,
            'model_number' => $request->model_number,
        ]);
    ...
    public function registerPhdView() {
        return view('backend.datatables.register.register_phd_datatables');
    }
    ...
    public function registerPhdDataUserIdUpdate(Request $request) {
        ...
        $userAdmissionInfo->update([
            ...
            'accounts_status' => $request->accounts_status,
            'correspondence' => $request->correspondence,
            'academic_guide' => $request->academic_guide_register_phd,
            'en_academic_guide' => User::where('role', 'academic-guide')->where('name', $request->academic_guide_register_phd)->first()->en_name,
            'model_number' => $request->model_number,
        ]);
    ...
    public function movementBachelorView() {
        return view('backend.datatables.movement.movement_bachelor_datatables');
    }

    public function movementBachelorData() {
        $model = User::select('users.id', 'users.degree_needed')->with('file_movement' , 'user_admission_forms')
        ->whereHas('user_admission_forms', function ($q) {
            $q->movementAdmissionForm();
        })
        ->where('users.degree_needed', 'Bachelor')
        ->where('users.role', 'user');
    ...
    public function movementMasterView() {
        return view('backend.datatables.movement.movement_master_datatables');
    }
    ...
    public function movementPhdView() {
        return view('backend.datatables.movement.movement_phd_datatables');
    }
    ...
    public function academicGuideView($name) {
        ...
        return view('backend.datatables.reports.academic_guide.academic_guide_reports_datatables', compact('name', 'totalMoneyRecievedForFirstPayment', 'totalMoneyRecievedForSecondPayment', 'totalMoneyRecievedForThirdPayment', 'totalMoneyRecievedForFourthPayment', 'totalMoneyShouldRecieved', 'totalMoneyMissing'))
        ->with('academic_chart', json_encode($array))
        ->with('degrees', json_encode($array1));
    }
