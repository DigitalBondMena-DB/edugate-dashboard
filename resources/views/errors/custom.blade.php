...
<head>
    ...
    <script src="{{ asset('frontend/brokebot/cdnjs.cloudflare.com/ajax/libs/gsap/latest/TweenMax.min.js') }}" />
    </script>
    <script type="text/javascript" src="{{ asset('frontend/brokebot/js/brokebot.js') }}" />
    </script>
    ...
    <div>
        ...
        <div class="robotpage-top-half">
            <div id="robot_holder ">
                ...
                <svg id="brokebotSVG" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 551 239"
                    enable-background="new 0 0 551 239" xml:space="preserve" preserveAspectRatio="xMidYMax">
                    ...
                    <g id="robotHead">
                        ...
                        <path class="robot_limbs_and_ears"
       ...
       C429.3,234.4,424.8,238.9,419.3,238.9z" />
                        ...
                        <g id="eyesMove">
                            <g id="eyesBlink">
                                ...
                                <polygon class="robot_eyes_highlight"
       ...
       C226.3,231.8,224,234.1,221.3,234.1z" />
                        ...
                        <g id="upperBody">
                            ...
                            <rect x="146" y="143" transform="matrix(-0.968 -0.2511 0.2511 -0.968 362.8447 338.4026)"
                                class="robot_limbs_and_ears" width="114" height="6.1" />
                            <g id="leftArm">
         ...
         C262.9,206.7,253.5,206.7,247.7,212.6z" />
                                <rect x="254.7" y="161.1" class="robot_limbs_and_ears" width="7"
                                    height="25" />
        ...
        C261.8,174.3,268.7,170.3,270.4,163.5z" />
                            ...
                            <rect x="130" y="138.3" transform="matrix(0.8845 0.4666 -0.4666 0.8845 83.8309 -45.3494)"
                                class="robot_limbs_and_ears" width="7" height="16.7" />
                            <g id="rightLowerArm">
                                <path id="rightInnerClaw" class="robot_hands_feet"
                                    d="M119,181.3l21.1,21.1c5.8-5.8,5.8-15.3,0-21.1C134.2,175.5,124.8,175.5,119,181.3z" />
                                <path id="rightOuterClaw" class="robot_hands_feet"
