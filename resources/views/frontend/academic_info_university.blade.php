...
@section('title')
	@if(app()->getLocale() == 'en')
        EGEC | Academic Information (Graduate)
    @else
        EGEC | المعلومات الأكاديمية (خريج)
	@endif
@endsection
                ...
                <div class="container">
                    <div class="register-box">
                        ...
                        <div class="sec-title text-center mb-30">
                            <h2 class="title mb-10">Academic Information (Graduate)</h2>
                        </div>
                                ...
                                <div class="row clearfix">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select name="degree_name" id="degree_name" class="d-block" required>
                                            ...
                                            <option value="Bachelor" {{ isset($academicInfo) ? $academicInfo->degree_name == 'Bachelor' ? 'selected' : null : null }}>Bachelor</option>
                                          </select>
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input type="text" name="university_name" id="university_name" class="d-block" value="{{ isset($academicInfo) ? $academicInfo->university_name : null }}" required>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label>Faculty Name</label>
                                        <input type="text" name="faculty_name" id="faculty_name" class="d-block" value="{{ isset($academicInfo) ? $academicInfo->faculty_name : null }}" required>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label>Department Name</label>
                                        <input type="text" name="department_name" id="department_name" class="d-block" value="{{ isset($academicInfo) ? $academicInfo->department_name : null }}" required>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label>GPA</label>
                                        <input type="number" class="d-block" id="gpa_precentage" name="gpa_precentage" step=".01" placeholder="Write your GPA" value="{{ isset($academicInfo) ? $academicInfo->gpa_precentage : null }}"> 
                                        @if($errors->has('gpa_precentage'))
                                            <span class="text-danger">{{ $errors->first('gpa_precentage') }}</span>
                                        @endif
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label>Education System</label>
                                        <select class="d-block" name="education_system" id="education_system">
                                            <option value="">Select</option>
                                            <option value="انتظام" value="{{ isset($academicInfo) ? $academicInfo->education_system == 'انتظام' ? 'selected' : null : null }}">Entzam</option>
                                            <option value="انتساب" value="{{ isset($academicInfo) ? $academicInfo->education_system == 'انتساب' ? 'selected' : null : null }}">Entesab</option>
                                        </select>
        ...
        <section class="register-section pt-100 pb-100">
            <div class="container">
                <div class="register-box">
                    ...
                    <div class="sec-title text-center mb-30">
                        <h2 class="title mb-10">المعلومات الأكاديمية (خريج)</h2>
                    </div>
                    ...
                    <div class="styled-form">
                        ...
                        <form action="{{ route('submit-academic-info') }}" method="POST" enctype="multipart/form-data">    
                            ...
                            <div class="row clearfix">
                                <div class="form-group col-lg-6">
                                    <label style="float: right">مؤهل جامعي</label>
                                    <br>
                                    <select name="degree_name" id="degree_name" class="d-block" required>
                                        <option value="">اختر</option>
                                        <option value="Bachelor" {{ isset($academicInfo) ? $academicInfo->degree_name == 'Bachelor' ? 'selected' : null : null }}>بكالوريوس</option>
                                      </select>
                                    @if($errors->has('degree_name'))
                                        <span class="text-danger">{{ $errors->first('degree_name') }}</span>
                                    @endif
                                ...
                                <div class="form-group col-lg-6">
                                    <label style="float: right">سنة التخرج الجامعية</label>
                                    <br>
                                    <select name="degree_year" id="degree_year" class="d-block" required>
                                        <option value="">Select</option>
                                        <option value="2020" {{ isset($academicInfo) ? $academicInfo->degree_year == '2020' ? 'selected' : null : null }}>2020</option>
                                ...
                                <div class="form-group col-lg-6">
                                    <label style="float: right">بلد الجامعة</label>
                                    <br>
                                    <select id="degree_country" name="degree_country" class="d-block" required>
                                        <option value="Afghanistan" {{ isset($academicInfo) ? $academicInfo->degree_country == 'Afghanistan' ? 'selected' : null : null }}>Afghanistan</option>
                                        <option value="Åland Islands" {{ isset($academicInfo) ? $academicInfo->degree_country == 'Åland Islands' ? 'selected' : null : null }}>Åland Islands</option>
                                ...
                                <div class="form-group col-lg-6">
                                    <label style="float: right">اسم الجامعة</label>
                                    <br>
                                    <input type="text" name="university_name" id="university_name" class="d-block" value="{{ isset($academicInfo) ? $academicInfo->university_name : null }}" required>
                                </div>
                                <div class="form-group col-lg-6">
                                    <label style="float: right">اسم الكلية</label>
                                    <br>
                                    <input type="text" name="faculty_name" id="faculty_name" class="d-block" value="{{ isset($academicInfo) ? $academicInfo->faculty_name : null }}" required>
                                </div>
                                <div class="form-group col-lg-6">
                                    <label style="float: right">اسم القسم</label>
                                    <br>
                                    <input type="text" name="department_name" id="department_name" class="d-block" value="{{ isset($academicInfo) ? $academicInfo->department_name : null }}" required>
                                </div>
                                <div class="form-group col-lg-6">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <select class="d-block" name="education_system" id="education_system">
                                        <option value="">اختر</option>
                                        <option value="انتظام" value="{{ isset($academicInfo) ? $academicInfo->education_system == 'انتظام' ? 'selected' : null : null }}">انتظام</option>
                                        <option value="انتساب" value="{{ isset($academicInfo) ? $academicInfo->education_system == 'انتساب' ? 'selected' : null : null }}">انتساب</option>
                                    </select>
                                    @if($errors->has('education_system'))
                                        <span class="text-danger">{{ $errors->first('education_system') }}</span>
                                    @endif
