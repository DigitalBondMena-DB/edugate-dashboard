                ...
                <div class="card-body p-4">
                    <form action="{{ route('serviceuser.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-bold text-dark">Arabic Desription <span class="text-danger">*</span></label>
                                    <textarea name="ar_first_text" 
                                              id="ar_first_text" 
                                              class="form-control @error('ar_first_text') is-invalid @enderror" 
                                              rows="4"
                                              placeholder="Enter Service Description in Arabic">{{ old('ar_first_text') }}</textarea>
                                    @error('ar_first_text')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-bold text-dark">English Desription <span class="text-danger">*</span></label>
                                    <textarea name="en_first_text" 
                                              id="en_first_text" 
                                              class="form-control @error('en_first_text') is-invalid @enderror" 
                                              rows="4"
                                              placeholder="Enter Service Description in English">{{ old('en_first_text') }}</textarea>
                                    @error('en_first_text')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold text-dark">Service Image <span class="text-danger">*</span></label>
