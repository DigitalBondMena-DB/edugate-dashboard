                            ...
                            <table class="table table-striped table-hover align-middle mb-0">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th scope="col" class="text-center" style="width: 35%;">Service Name (AR)</th>
                                        <th scope="col" class="text-center" style="width: 35%;">Service Name (EN)</th>
                                        <th scope="col" class="text-center" style="width: 120px;">Service Image</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="text-center">
                                                    <div class="text-dark fw-bold">{{ $service->ar_name }}</div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="text-center">
                                                    <div class="text-dark fw-bold">{{ $service->en_name }}</div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <div class="position-relative image-preview-container">
                                                        <img class="rounded border shadow-sm slider-thumbnail" 
                                                             ...
                                                             src="{{ asset('serviceuser/' . $service->image) }}" 
                                                             alt="Partner Image"
                                                    ...
                                                    <div class="modal-dialog modal-lg modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="imageModalLabel{{ $service->id }}">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    {{-- Edit Button --}}
                                                    <a href="{{ route('serviceuser.edit', $service->id) }}" class="text-decoration-none">
                                                        <button class="btn btn-outline-primary btn-sm" 
                                                                title="Edit Services" data-bs-toggle="tooltip">
                                                    ...
                                                    @if($service->active === 'activated')
                                                        <form action="{{ route('serviceuser.toggleStatus', $service->id) }}" method="POST" class="d-inline">
                                                            ...
                                                            <button class="btn btn-outline-warning btn-sm" type="submit"
                                                                    title="Deactivate Services" data-bs-toggle="tooltip"
                                                                    onclick="return confirm('Are you sure you want to deactivate this Services?');">
                                                    ...
                                                    @else
                                                        <form action="{{ route('serviceuser.toggleStatus', $service->id) }}" method="POST" class="d-inline">
                                                            ...
                                                            <button class="btn btn-outline-success btn-sm" type="submit"
                                                                    title="Activate Services" data-bs-toggle="tooltip"
                                                                    onclick="return confirm('Are you sure you want to activate this Services?');">
