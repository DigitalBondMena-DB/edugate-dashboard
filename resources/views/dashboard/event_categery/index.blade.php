                        ...
                        <form action="{{ route('event-categery.toggleStatus', $row->id) }}" method="POST" class="d-inline">
                          ...
                          @if(($row->active ?? null) === 'activated')
                            <button class="btn btn-outline-warning btn-sm" type="submit"
                                    onclick="return confirm('Deactivate this category?');" title="Deactivate">
                              <i class="fa-solid fa-eye"></i>
                            </button>
                          @else
                            <button class="btn btn-outline-success btn-sm" type="submit"
                                    onclick="return confirm('Activate this category?');" title="Activate">
...
<style>
  ...
  @media (max-width: 991px){ .actions-cell{ min-width: 130px; } }
</style>
@endsection
