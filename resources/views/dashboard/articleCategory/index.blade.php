                ...
                <div class="card-header card-header-primary">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 col-6 text-end">
                            <a class="btn btn-white btn-round shadow-sm px-4" href="{{ route('articleCategory.create') }}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="text-center">
                                                    <div class="text-dark fw-bold">{{ $category->ar_title }}</div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="text-center">
                                                    <div class="text-dark fw-bold">{{ $category->en_title }}</div>
                                                </div>
                                            </td>
                                            <td>
