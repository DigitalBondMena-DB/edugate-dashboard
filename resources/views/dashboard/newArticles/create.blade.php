      ...
      <div class="card-body p-4">
        <form action="{{ route('newArticle.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row g-4 mt-1">
              ...
              <textarea name="ar_text" id="ar_text"
          ...
          <div class="row g-4 mt-1">
              ...
              <textarea name="en_text" id="en_text"
          ...
          <div class="row g-4 mt-1">
            <div class="col-md-6">
              <label class="form-label fw-bold">Arabic Tag Title <span class="text-danger">*</span></label>
            ...
            <div class="col-md-6">
              <label class="form-label fw-bold">Arabic Tag Description <span class="text-danger">*</span></label>
              <textarea name="ar_tag_desc" id="ar_tag_desc"
            ...
            <div class="col-md-6">
              ...
              <textarea name="en_tag_desc" id="en_tag_desc"
          ...
          <div class="row g-4 mt-1">
            <div class="col-md-6">
              ...
              <textarea name="blog_script" id="blog_script"
            ...
            <div class="col-md-6">
              ...
              <textarea name="blog_second_script" id="blog_second_script"
                        ...
                        rows="3" placeholder="Blog second script in Arabic">{{ old('blog_second_script') }}</textarea>
          ...
          <div class="row g-4 mt-1">
            ...
            <div class="col-md-6">
              ...
              <div id="timeError" class="text-danger small mt-1" style="display:none;">Cannot select time before the current time</div>
              @error('schedule_time') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
            </div>
          </div>
...
<script>
  ...
  if(dInput && !dInput.value){ dInput.value = today(); dInput.min = today(); }
  if(tInput && !tInput.value){ tInput.value = nowHM(); }
