                    ...
                    <div class="table-responsive">
                        @if(!empty($about))
                            <table class="table table-striped table-hover align-middle mb-0">
                                <thead class="table-light">
                                    <tr>
                                        <th scope="col" class="text-center" style="width: 35%;">Story (AR)</th>
                                        <th scope="col" class="text-center" style="width: 35%;">Story (EN)</th>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="text-center">
                                                    <div class="text-dark fw-bold">{{ $about->ar_story}}</div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="text-center">
                                                    <div class="text-dark fw-bold">{{ $about->en_story }}</div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                ...
                                                {{-- Image Modal --}}
                                                <div class="modal fade" id="imageModal{{ 1 }}" tabindex="-1" aria-labelledby="imageModalLabel{{ $about->id }}" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="imageModalLabel{{ 1 }}">
                                                                    <i class="fas fa-image me-2"></i>About Preview
                                                                </h5>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    {{-- Edit Button --}}
                                                    <a href="{{ route('about.edit')}}" class="text-decoration-none">
                                                        <button class="btn btn-outline-primary btn-sm" 
                                                                title="Edit About" data-bs-toggle="tooltip">
                        ...
                        @else
                            <div class="text-center py-5">
                                ...
                                <h5 class="text-muted mb-3">No About Available</h5>
                            </div>
                        @endif
                    </div>
                </div>
