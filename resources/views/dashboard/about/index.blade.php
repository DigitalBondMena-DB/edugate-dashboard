            ...
            <table class="table table-hover align-middle mb-0 clean-head fixed-cols">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="text-start">
                    <div class="story-full">{{ strlen($about->ar_story) > 100 ? substr($about->ar_story, 0, 100) . '...' : $about->ar_story  }}</div>
                  </td>


                  <td class="text-start">
                    <div class="story-full">{{ strlen($about->en_story) > 100 ? substr($about->en_story, 0, 100) . '...' : $about->en_story  }}</div>
                  </td>
                  ...
                  <td class="text-center">
                    ...
                    <div class="modal fade" id="imageModal{{ $about->id ?? 'about' }}" tabindex="-1" aria-hidden="true">
                      <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title"><i class="fas fa-image me-2"></i> About Image</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                          </div>
                          <div class="modal-body text-center p-0">
                            <img src="{{ asset('about/' . $about->image) }}" class="img-fluid rounded" style="max-height:70vh;object-fit:contain" alt="About Image Full">
                          </div>
                  ...
                  <td class="text-center">
                    <a href="{{ route('about.edit') }}" class="btn btn-outline-primary btn-sm" title="Edit About">
                      ✏️ Edit
                    </a>
                  </td>
                </tr>
...
<style>
  ...
  .table.clean-head thead td { border-bottom: 0 !important; }
  .table.clean-head tbody td { border-top: 1px solid #eee; }

  .slider-thumbnail { transition: all .25s ease-in-out; }
  .slider-thumbnail:hover { transform: scale(1.06); box-shadow: 0 6px 16px rgba(0,0,0,.22); }
