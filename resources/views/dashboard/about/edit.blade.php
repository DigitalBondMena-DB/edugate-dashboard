                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('about.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-bold text-dark">Arabic Mission <span
                                            class="text-danger">*</span></label>
                                    <textarea name="ar_mission" id="ar_mission" class="form-control @error('ar_mission') is-invalid @enderror"
                                        rows="4" placeholder="Enter mission in Arabic">{{ old('ar_mission', $about->ar_mission) }}</textarea>
                                    @error('ar_mission')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-bold text-dark">English Mission <span
                                            class="text-danger">*</span></label>
                                    <textarea name="en_mission" id="en_mission" class="form-control @error('en_mission') is-invalid @enderror"
                                        rows="4" placeholder="Enter mission in English">{{ old('en_mission', $about->en_mission) }}</textarea>
                                    @error('en_mission')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-bold text-dark">Arabic Vision <span
                                            class="text-danger">*</span></label>
                                    <textarea name="ar_vision" id="ar_vision" class="form-control @error('ar_vision') is-invalid @enderror" rows="4"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-bold text-dark">English Vision <span
                                            class="text-danger">*</span></label>
                                    <textarea name="en_vision" id="en_vision" class="form-control @error('en_vision') is-invalid @enderror" rows="4"
                        ...
                        <div class="mb-4">
                            ...
                            @if ($about->image)
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <div class="position-relative image-preview-container">
                                                    <img class="rounded border shadow-sm slider-thumbnail"
                                                        ...
                                                        src="{{ asset('about/' . $about->image) }}" alt="Current Image"
                                ...
                                {{-- Image Modal --}}
                                <div class="modal fade" id="imageModal{{ $about->id }}" tabindex="-1"
                                    aria-labelledby="imageModalLabel{{ $about->id }}" aria-hidden="true">
