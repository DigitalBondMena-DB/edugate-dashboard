                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <select name="new_article_catrgory_id" class="form-control @error('new_article_catrgory_id') is-invalid @enderror">
                                        <option value="">Select Category</option>
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" {{ old('new_article_catrgory_id') == $category->id ? 'selected' : '' }}>
