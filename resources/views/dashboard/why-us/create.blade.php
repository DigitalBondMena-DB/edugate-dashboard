...
@php $pageTitle = 'Add Why Us Field'; @endphp
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('why-us.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="field_ar"
                                class="form-control @error('field_ar') is-invalid @enderror" value="{{ old('field_ar') }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="field_en"
                                class="form-control @error('field_en') is-invalid @enderror" value="{{ old('field_en') }}"
