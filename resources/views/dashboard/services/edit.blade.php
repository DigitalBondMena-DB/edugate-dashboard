                ...
                <div class="card-body p-4">
                    <form action="{{ route('service.update', $row->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-bold text-dark">Arabic Job Title <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="ar_job_title" id="ar_job_title"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-bold text-dark">English Job Title <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="en_job_title" id="en_job_title"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-bold text-dark">Arabic Text <span
                                            class="text-danger">*</span></label>
                                    <textarea name="ar_text" id="ar_text" class="form-control @error('ar_text') is-invalid @enderror" rows="4"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-bold text-dark">English Text <span
                                            class="text-danger">*</span></label>
                                    <textarea name="en_text" id="en_text" class="form-control @error('en_text') is-invalid @enderror" rows="4"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-center p-0">
                                                <img src="{{ asset('service/' . $row->image) }}"
                                                    class="img-fluid rounded" alt="Full Size Feedback Image"
