        ...
        <div class="table-responsive">
          @if(count($rows))
            <table class="table table-hover align-middle mb-0 fixed-table clean-head">
              {{-- توزيع الأعمدة ثابت ومجموعه 100% --}}
              <colgroup>
                <col style="width:6%">   {{-- # --}}
                <col style="width:28%">  {{-- Name AR --}}
                <col style="width:28%">  {{-- Name EN --}}
                ...
                @foreach($rows as $feedback)
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      >
                      {{-- Image Modal --}}
                      <div class="modal fade" id="imageModal{{ $feedback->id }}" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <div class="modal-body text-center p-0">
                              <img src="{{ asset('service/' . $feedback->image) }}" class="img-fluid rounded"
                                   style="max-height:70vh;object-fit:contain" alt="Full Size Feedback Image">
                            </div>
                          </div>
                        </div>
                      </div>
