                  ...
                  <tr>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title"><i class="fas fa-image me-2"></i> Logo Preview</h5>
                              <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                            </div>
                            <div class="modal-body text-center p-0">
                              <img src="{{ asset('clients/' . $partner->logo) }}" class="img-fluid rounded"
                                   style="max-height:70vh;object-fit:contain" alt="Full Partner Logo">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <td class="text-center">
                      <div class="d-flex justify-content-center gap-2">
                        <a href="{{ route('clients.edit', $partner->id) }}" class="btn btn-outline-primary btn-sm"
                           title="Edit Partner"><i class="fas fa-edit"></i></a>
...
<style>
  ...
  .slider-thumbnail { transition: all .3s ease; }
  .slider-thumbnail:hover { transform: scale(1.05); box-shadow: 0 4px 15px rgba(0,0,0,.2); }
  .fixed-table { table-layout: fixed; }
</style>
@endsection
