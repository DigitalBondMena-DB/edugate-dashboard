    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-light border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 col-6 text-end">
                            <a class="btn btn-white btn-round shadow-sm px-4" href="{{ route('enBlog.create') }}">
                ...
                {{-- Filter Bar --}}
                <form method="GET" action="{{ route('enBlog.index') }}" class="px-3 py-3 border-bottom">
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col-md-2 d-flex gap-2">
                            ...
                            <a href="{{ route('enBlog.index') }}" class="btn btn-light w-100"><i
                                    ...
                                    @foreach ($rows as $article)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <img src="{{ asset('enBlogs/' . $article->image) }}"
                                            ...
                                            <td class="text-center actions-cell">
                                                <div class="d-flex justify-content-center gap-2 flex-wrap">
                                                    <a href="{{ route('enBlog.edit', $article->id) }}"
                                                        class="btn btn-outline-primary btn-sm" title="Edit">✏️</a>

                                                    @if ($article->status == 1)
                                                        <form action="{{ route('enBlog.toggleStatus', $article->id) }}"
