                ...
                <div class="card-body p-4">
                    <form action="{{ route('page-banners.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-bold text-dark">Arabic Alt <span class="text-danger">*</span></label>
                                    <input type="ar_alt"
                                        name="ar_alt"
                                        id="ar_alt"
                                        class="form-control @error('ar_alt') is-invalid @enderror"
                                        value="{{ old('ar_alt', $banner->ar_alt) }}"
                                        placeholder="Enter Arabic Alt">
                                    @error('ar_alt')
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-bold text-dark">English Alt <span class="text-danger">*</span></label>
                                    <input type="en_alt"
                                        name="en_alt"
                                        id="en_alt"
                                        class="form-control @error('en_alt') is-invalid @enderror"
                                        value="{{ old('en_alt', $banner->en_alt) }}"
                                        placeholder="Enter English Alt">
                                    @error('en_alt')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
