...
@php $pageTitle = 'احصائيات البكالوريس'; @endphp
        ...
        <section id="dashboard-ecommerce">
                ...
                <div class="col-lg-6 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="text-center">مخطط دائري لنسبة البكالوريوس</h5>
                        </div>
                                    ...
                                    <div class="card text-center">
                                        <div class="card-content">
                                            <div class="card-body py-1">
                                                ...
                                                <div class="text-muted line-ellipsis">عدد البكالوريس</div>
                                    ...
                                    <div class="card text-center">
                                        <div class="card-content">
                                            <div class="card-body py-1">
                                                ...
                                                <div class="text-muted line-ellipsis">عدد عملاء البكالوريس</div>
                                    ...
                                    <div class="card text-center">
                                        <div class="card-content">
                                            <div class="card-body py-1">
                                                ...
                                                <div class="text-muted line-ellipsis">عدد تسجيل البكالوريس</div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="text-center">مخطط شريطي لاجمالي الاموال المحصله لكل المرشدين الاكاديمين لدرجة البكالوريوس</h5>
                        </div>
                        <div class="card-content">
                            <div class="card-body pl-0">
                ...
                <div class="col-lg-6 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="text-center">مخطط شريطي لاجمالي الاموال المحصله للدفعه الاولى لكل المرشدين الاكاديمين لدرجه البكالوريوس</h5>
                        </div>
                        <div class="card-content">
                            <div class="card-body pl-0">
                ...
                <div class="col-lg-6 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="text-center">مخطط شريطي لاجمالي الاموال المحصله للدفعه المتابعه لكل المرشدين الاكاديمين لدرجه البكالوريوس</h5>
                        </div>
                        <div class="card-content">
                            <div class="card-body pl-0">
                ...
                <div class="col-lg-6 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="text-center">مخطط شريطي لاجمالي الاموال المحصله للدفعه قدم وفتح الملف لكل المرشدين الاكاديمين لدرجه البكالوريوس</h5>
                        </div>
                        <div class="card-content">
                            <div class="card-body pl-0">
                ...
                <div class="col-lg-6 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="text-center">مخطط شريطي لاجمالي الاموال المحصله للدفعه لغلق الملف لكل المرشدين الاكاديمين لدرجه البكالوريوس</h5>
                        </div>
                        <div class="card-content">
                            <div class="card-body pl-0">
                ...
                <div class="col-xl-12 col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center pb-50">
                            <h4 class="card-title">الحسابات لدرجه البكالوريوس</h4>
                        </div>
                        <div class="card-content">
                ...
                <div class="col-xl-6 col-12 dashboard-marketing-campaign">
                    <div class="card marketing-campaigns">
                        <div class="card-header d-flex justify-content-between align-items-center pb-1">
                            <h4 class="card-title"> اجدد عملاء البكالوريس</h4>
                ...
                <div class="col-xl-6 col-12 dashboard-marketing-campaign">
                    <div class="card marketing-campaigns">
                        <div class="card-header d-flex justify-content-between align-items-center pb-1">
                            <h4 class="card-title">اجدد عملاء تسجيل البكالوريس</h4>
                            <i class="bx bx-dots-vertical-rounded font-medium-3 cursor-pointer"></i>
                        </div>
                        <div class="card-content">
                            <div class="card-body pb-0">
