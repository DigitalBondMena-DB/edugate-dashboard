...
@php $pageTitle = 'Add Article Sub Category'; @endphp
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ar_tag_title" id="ar_tag_title" class="form-control" value="{{ old('ar_tag_title') }}">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ar_tag_description" id="ar_tag_description" class="form-control" value="{{ old('ar_tag_description') }}">
                                    </div>
