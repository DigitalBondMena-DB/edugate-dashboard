...
@php $pageTitle = 'تعديل الأماكن'; @endphp
...
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card-body">
                        <form action="{{ route('destinations.update', $row->id) }}" method="POST" enctype="multipart/form-data">
                            {{ method_field('put') }}
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="5" rows="10" name="en_about_the_destination" id="en_about_the_destination" class="form-control">{{ $row->en_about_the_destination }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="5" rows="10" name="ar_about_the_destination" id="ar_about_the_destination" class="form-control">{{ $row->ar_about_the_destination }}</textarea>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        @if($row->flag !== NULL)
                                            <div class="col text-center">
                                                <img src="{{ asset('destinations/' . $row->flag) }}" width="100px" height="100px;">
                                            </div>
                                        @endif
                                    </div>
                                    @if($errors->has('flag'))
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        @if($row->featured_image !== NULL)
                                            <div class="col text-center">
                                                <img src="{{ asset('destinations/' . $row->featured_image) }}" width="100px" height="100px;">
                                            </div>
                                        @endif
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        @if($row->banner_image !== NULL)
                                            <div class="col text-center">
                                                <img src="{{ asset('destinations/' . $row->banner_image) }}" width="100px" height="100px;">
                                            </div>
                                        @endif
                                    </div>
                        ...
                        <button type="submit" class="btn btn-primary pull-right">تعديل الأماكن</button>
