      ...
      text-align: left;
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <form action="{{ route('serviceAboutSection.update', $row->id) }}" method="POST" enctype="multipart/form-data">
                            {{ method_field('PUT') }}
                            {{ csrf_field() }}
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="20" cols="20" name="en_text" id="edit" class="form-control">{{ $row->en_text }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="20" cols="20" name="ar_text" id="edit" class="form-control">{{ $row->ar_text }}</textarea>
                                    </div>
                        ...
                        <button type="submit" class="btn btn-primary pull-right">Edit Service</button>
