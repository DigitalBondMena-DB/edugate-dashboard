...
@php $pageTitle = 'Service Section Control'; @endphp
            ...
            <div class="card-header card-header-primary">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-6 text-right">
                        <a class="btn btn-white btn-round" href="{{ route('serviceAboutSection.create') }}">Add Service</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td class="td-actions row no-gutters align-items-center justify-content-center">
                          <div class="col-6">
                            ...
                            <a href="{{ route('serviceAboutSection.edit', $service->id) }}">
                          ...
                          <div class="col-6">
                              <form action="{{ route('serviceAboutSection.destroy', $service->id) }}" method="POST">
                                  {{ csrf_field() }}
                                  {{ method_field('delete') }}
