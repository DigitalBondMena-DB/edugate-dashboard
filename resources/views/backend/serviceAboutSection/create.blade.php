      ...
      text-align: left;
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <form action="{{ route('serviceAboutSection.store') }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">

                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="bmd-label-floating">Service Title in English</label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="bmd-label-floating">Service Text in English</label>
                                        <textarea rows="20" cols="20" name="en_text" id="edit" class="form-control">{{ old('en_text') }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="bmd-label-floating">Service Text in Arabic</label>
                                        <textarea rows="20" cols="20" name="ar_text" id="edit" class="form-control">{{ old('ar_text') }}</textarea>
                                    </div>
                            ...
                            <button type="submit" class="btn btn-primary pull-right">Add Service About Section</button>
