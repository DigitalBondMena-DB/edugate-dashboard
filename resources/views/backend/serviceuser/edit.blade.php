                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" cols="10" name="ar_first_text" id="edit" class="form-control">{{ $row->ar_first_text }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" cols="10" name="ar_second_text" id="edit" class="form-control">{{ $row->ar_second_text }}</textarea>
                                    </div>
                                        ...
                                        <input type="file" name="image">
                                            @if($row->image !== NULL)
                                                <div class="col text-center">
                                                    <img src="{{ asset('serviceuser/' . $row->image) }}" width="100px" height="100px;">
                                                </div>
                                            @endif
                                    </div>
                                    @if($errors->has('image'))
