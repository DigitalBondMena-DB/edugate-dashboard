            ...
            <div class="card-header card-header-primary">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-6 text-right">
                        <a class="btn btn-white btn-round" href="{{ route('serviceuser.create') }}">Add Service</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered table-striped">
                  ...
                  @foreach ($rows as $service)
                    <tr>
                        ...
                        <td>
                          <img src="{{ asset('serviceuser/' . $service->image) }}" width="100px" height="100px">
                        </td>
                        <td class="td-actions row no-gutters align-items-center justify-content-center">
                          ...
                          <div class="col-6">
                              <form action="{{ route('serviceuser.destroy', $service->id) }}" method="POST">
                                  {{ csrf_field() }}
                                  {{ method_field('delete') }}
