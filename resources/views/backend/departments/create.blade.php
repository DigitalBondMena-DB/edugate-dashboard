...
@php $pageTitle = 'اضف الإدارات'; @endphp
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="5" rows="10" name="en_department_vision" id="en_department_vision" class="form-control">{{ old('en_department_vision') }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="5" rows="10" name="ar_department_vision" id="ar_department_vision" class="form-control">{{ old('ar_department_vision') }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="5" rows="10" name="en_department_mission" id="en_department_mission" class="form-control">{{ old('en_department_mission') }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="5" rows="10" name="ar_department_mission" id="ar_department_mission" class="form-control">{{ old('ar_department_mission') }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="facultyMajorUniversities[]" class="form-control" style="height:334px;" multiple>
                                            @foreach($facultyMajorUniversities as $facultyMajorUniversity)
                                                <option value="{{$facultyMajorUniversity->id}}">{{ $facultyMajorUniversity->faculty_name }} {{ $facultyMajorUniversity->university_name }} ({{ $facultyMajorUniversity->major_name }})</option>
                                            @endforeach
                                        </select>                                            
                                    </div>
                        ...
                        <button type="submit" class="btn btn-primary pull-right">اضف الإدارات</button>
