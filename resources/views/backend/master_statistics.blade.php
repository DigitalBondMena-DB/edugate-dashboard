        ...
        <section id="dashboard-ecommerce">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="text-center">مخطط شريطي لاجمالي الاموال المحصله لكل المرشدين الاكاديمين لدرجة الماجستير</h5>
                        </div>
                        <div class="card-content">
                            <div class="card-body pl-0">
                ...
                <div class="col-lg-6 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="text-center">مخطط شريطي لاجمالي الاموال المحصله للدفعه الاولى لكل المرشدين الاكاديمين لدرجه الماجستير</h5>
                        </div>
                        <div class="card-content">
                            <div class="card-body pl-0">
                ...
                <div class="col-lg-6 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="text-center">مخطط شريطي لاجمالي الاموال المحصله للدفعه المتابعه لكل المرشدين الاكاديمين لدرجه الماجستير</h5>
                        </div>
                        <div class="card-content">
                            <div class="card-body pl-0">
                ...
                <div class="col-lg-6 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="text-center">مخطط شريطي لاجمالي الاموال المحصله للدفعه قدم وفتح الملف لكل المرشدين الاكاديمين لدرجه الماجستير</h5>
                        </div>
                        <div class="card-content">
                            <div class="card-body pl-0">
                ...
                <div class="col-lg-6 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="text-center">مخطط شريطي لاجمالي الاموال المحصله للدفعه لغلق الملف لكل المرشدين الاكاديمين لدرجه الماجستير</h5>
                        </div>
                        <div class="card-content">
                            <div class="card-body pl-0">
                ...
                <div class="col-xl-6 col-12 dashboard-marketing-campaign">
                    <div class="card marketing-campaigns">
                        <div class="card-header d-flex justify-content-between align-items-center pb-1">
                            <h4 class="card-title">اجدد عملاء الماجستير</h4>
                ...
                <div class="col-xl-6 col-12 dashboard-marketing-campaign">
                    <div class="card marketing-campaigns">
                        <div class="card-header d-flex justify-content-between align-items-center pb-1">
                            <h4 class="card-title">اجدد عملاء تسجيل الماجستير</h4>
                            <i class="bx bx-dots-vertical-rounded font-medium-3 cursor-pointer"></i>
                        </div>
                        <div class="card-content">
                            <div class="card-body pb-0">
