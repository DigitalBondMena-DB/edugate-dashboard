...
@php $pageTitle = 'تعديل العميل'; @endphp
                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-right">
                                <a class="btn btn-white btn-round" href="{{ route('ad-form-areas.show', $row->id) }}">Show Areas</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('ad-form-countries.update', $row->id) }}" method="POST" enctype="multipart/form-data">
                            {{ method_field('put') }}
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <button type="submit" class="btn btn-primary pull-right">تعديل الدولة</button>
