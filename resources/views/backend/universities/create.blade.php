...
@php $pageTitle = 'اضافة جامعة'; @endphp
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="5" rows="10" name="en_about_the_university" id="en_about_the_university" class="form-control">{{ old('en_about_the_university') }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="5" rows="10" name="ar_about_the_university" id="ar_about_the_university" class="form-control">{{ old('ar_about_the_university') }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="5" rows="10" name="en_university_vision" id="en_university_vision" class="form-control">{{ old('en_university_vision') }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="5" rows="10" name="ar_university_vision" id="ar_university_vision" class="form-control">{{ old('ar_university_vision') }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="5" rows="10" name="en_university_mission" id="en_university_mission" class="form-control">{{ old('en_university_mission') }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="5" rows="10" name="ar_university_mission" id="ar_university_mission" class="form-control">{{ old('ar_university_mission') }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="en_governorate" id="en_governorate" class="form-control" value="{{ old('en_governorate') }}">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ar_governorate" id="ar_governorate" class="form-control" value="{{ old('ar_governorate') }}">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="en_address" id="en_address" class="form-control" value="{{ old('en_address') }}">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ar_address" id="ar_address" class="form-control" value="{{ old('ar_address') }}">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="url" name="university_site" id="university_site" class="form-control" value="{{ old('university_site') }}">
                                    </div>
                        ...
                        <button type="submit" class="btn btn-primary pull-right">اضافة جامعة</button>
