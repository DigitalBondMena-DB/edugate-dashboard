...
@php $pageTitle = 'تعديل شعبة'; @endphp
...
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card-body">
                        <form action="{{ route('specializations.update', $row->id) }}" method="POST" enctype="multipart/form-data">
                            {{ method_field('put') }}
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="5" rows="10" name="en_specialization_vision" id="en_specialization_vision" class="form-control">{{ $row->en_specialization_vision}}</textarea>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="5" rows="10" name="ar_specialization_vision" id="ar_specialization_vision" class="form-control">{{ $row->ar_specialization_vision }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="5" rows="10" name="en_specialization_mission" id="en_specialization_mission" class="form-control">{{ $row->en_specialization_mission }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="5" rows="10" name="ar_specialization_mission" id="ar_specialization_mission" class="form-control">{{ $row->ar_specialization_mission }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="department_id" class="form-control">
                                            ...
                                            @foreach($departments as $department)
                                                <option value="{{$department->id}}" {{ $row->department_id == $department->id ? 'selected' : null }}>{{ $department->en_name }}</option>
                                            @endforeach
                                        </select>                                            
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        @if($row->featured_image !== NULL)
                                            <div class="col text-center">
                                                <img src="{{ asset('specializations/' . $row->featured_image) }}" width="100px" height="100px;">
                                            </div>
                                        @endif
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        @if($row->banner_image !== NULL)
                                            <div class="col text-center">
                                                <img src="{{ asset('specializations/' . $row->banner_image) }}" width="100px" height="100px;">
                                            </div>
                                        @endif
                                    </div>
                        ...
                        <button type="submit" class="btn btn-primary pull-right">تعديل شعبة</button>
